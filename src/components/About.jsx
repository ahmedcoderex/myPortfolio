      ...
      <div className="container flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-7">
        ...
        >
          <motion.div
            ...
            className="box backdrop-blur-2xl mb-5 p-2.5 flex gap-5 rounded-md "
          >
            ...
            <div>
              ...
              <p className="text-xl leading-8 text-(--text-muted)">
                I learn to design and develop interactive and modern web
                interfaces...
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xl leading-8 text-(--text-muted)">
                I explore ways to enhance user interfaces with CSS and Tailwind
                CSS...
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            variants={boxVariants}
            className="box backdrop-blur-2xl  p-2.5 flex gap-5 rounded-md "
          >
            <div className="icon text-2xl bg-(--bg)  w-10 h-10 flex justify-center items-center rounded-full p-5">
            ...
            <div>
              ...
              <p className="text-xl leading-8 text-(--text-muted)">
                I apply my skills daily in small projects...
              </p>
            </div>
          </motion.div>
        </motion.section>
